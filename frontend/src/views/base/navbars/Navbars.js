      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <CNavbar expandable="sm" color="info">
            ...
            <CNavbarBrand>导航栏</CNavbarBrand>
            <CCollapse show={visible} navbar>
              <CNavbarNav>
                <CNavLink>首页</CNavLink>
                <CNavLink>连接</CNavLink>
              </CNavbarNav>
              <CNavbarNav className="ms-auto">
                ...
                <CDropdown inNav>
                  <CDropdownToggle color="primary">语言</CDropdownToggle>
                  <CDropdownMenu>
                ...
                <CDropdown inNav>
                  ...
                  <CDropdownMenu>
                    <CDropdownItem>账户</CDropdownItem>
                    <CDropdownItem>设置</CDropdownItem>
                  </CDropdownMenu>
                </CDropdown>
              </CNavbarNav>
            </CCollapse>
          ...
          <CNavbar expandable="false" color="primary">
            ...
            <CCollapse show={isOpenDropdown} navbar>
              <CNavbarNav>
                ...
                <CDropdown inNav>
                  <CDropdownToggle color="primary">用户</CDropdownToggle>
                  <CDropdownMenu>
                    <CDropdownItem>账户</CDropdownItem>
                    <CDropdownItem>设置</CDropdownItem>
                  </CDropdownMenu>
