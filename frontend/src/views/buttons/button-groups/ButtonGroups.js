          ...
          <CCardBody>
            ...
            <DocsExample href="components/button-group">
              <CButtonGroup role="group" aria-label="Basic example">
                <CButton color="primary">左</CButton>
                <CButton color="primary">中</CButton>
                <CButton color="primary">右</CButton>
              </CButtonGroup>
            </DocsExample>
            <p>
          ...
          <CCardBody>
            <DocsExample href="components/button-group#mixed-styles">
              <CButtonGroup role="group" aria-label="Basic mixed styles example">
                <CButton color="danger">左</CButton>
                <CButton color="warning">中</CButton>
                <CButton color="success">右</CButton>
              </CButtonGroup>
            </DocsExample>
          </CCardBody>
        </CCard>
