  ...
  return (
    <div className="decision-area">
      <div className="stock-container">
        {selectedStock.map((stock) => (
          <div key={stock} className="stock-item" style={{ flex: '1' }}>
            <div className="stock-name">{stock} 股份: {getStockAmount(stock)}</div>
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '10px' }}>
        <Button className="clear-button" onClick={handleClear} variant='outlined' style={{ color: '#e3f2fd' }}>撤销</Button>
        <Button
