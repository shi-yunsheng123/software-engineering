    ...
    <div className="background">
        ...
        <div className="wrapper d-flex flex-column min-vh-100" style={{ color: 'white' }}>
          ...
          <div className="d-flex justify-content-between align-items-center w-100">
            ...
            <div className="d-flex justify-content-center align-items-center flex-grow-1">
              <span className="mx-3">当前回合: {currentRound}/{MaxRound}</span>
              <span className="mx-3">当前日期： {currentDate.toISOString().split('T')[0]}</span>
              <span className="mx-3">倒计时: {counter}</span>
            </div>
            <CDropdown variant="dropdown">
              <CDropdownToggle caret={true}>
                <span style={{ color: 'white' }}>游戏积分: 50</span>
              </CDropdownToggle>
              ...
              <div className="right-section" style={{ flex: 1 }}>
                <div className="financials mb-3">
                  <div className="d-flex justify-content-between align-items-center w-100 mb-3">
                    <div style={{ marginTop: '21px', marginRight: '4px' }}>现金: ${cash.toFixed(2)}</div>
                    <div style={{ marginTop: '21px', marginRight: '4px' }}>投资组合金额: ${portfolioValue.toFixed(2)}</div>
                    <div style={{ marginTop: '21px', marginRight: '4px' }}>总资产: ${totalAssets.toFixed(2)}</div>
                  </div>
                  <div className="d-flex justify-content-between align-items-center w-100 mb-3">
                    <div style={{ marginRight: '4px' }}>AI 现金: ${aiCash.toFixed(2)}</div>
                    <div style={{ marginRight: '4px' }}>AI 投资组合金额: ${aiPortfolioValue.toFixed(2)}</div>
                    <div style={{ marginRight: '4px' }}>AI 总资产: ${aiTotalAssets.toFixed(2)}</div>
                  </div>
                </div>
      ...
      <Modal
        ...
        <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>
            策略 {currentDate.toISOString().split('T')[0]}
        </h2>
        <div style={{ marginBottom: '20px' }}>
            <h3 style={{ marginBottom: '10px', color: '#444' }}>玩家策略:</h3>
        ...
        <div style={{ marginBottom: '20px' }}>
            <h3 style={{ marginBottom: '10px', color: '#444' }}>AI策略:</h3>
